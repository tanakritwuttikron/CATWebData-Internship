...
<div class="container">
 ...
 <h1 class="mt-4 mb-3">ตรวจสอบข้อมูล สรุปสถานการณ์ของ สค.เชียงราย ส่งต่อเจ้าหน้าที่เวร ประจำปี</h1>
 ...
 <ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">ตรวจสอบข้อมูล สรุปสถานการณ์ของ สค.เชียงราย ส่งต่อเจ้าหน้าที่เวร ประจำปี</li>
 </ol>
 
 <legend><h3 class="mt-4 mb-3">เลือกวันที่ที่ต้องการตรวจสอบ</h3></legend>
 <hr>
 
<form action="report_year_frm2.php" method="post" >
 <div class="row">
