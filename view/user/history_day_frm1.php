...
<div class="container">
 ...
 <h1 class="mt-4 mb-3">ตรวจสอบข้อมูล สรุปเหตุขัดข้องวงจร ของ สค.เชียงราย  ส่งต่อเจ้าหน้าที่เวร ประจำวัน</h1>
 ...
 <ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">ตรวจสอบข้อมูล สรุปเหตุขัดข้องวงจร ของ สค.เชียงราย  ส่งต่อเจ้าหน้าที่เวร ประจำวัน</li>
 </ol>
 
 <legend><h3 class="mt-4 mb-3">เลือกวันที่ที่ต้องการตรวจสอบ</h3></legend>
 <hr>
 
<form action="day_daily_frm1.php" method="post" >
 <div class="row">
