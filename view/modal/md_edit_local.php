<!-- The Modal -->
<div class="modal fade" id="editLocalModal">
 <div class="modal-dialog">
   <div class="modal-content">
    ...
    <!-- Modal body -->
   <form action="../../database/update_local.php" method="post" name="md_form_local">
    <div class="modal-body">
    <div class="form-row">
     <input type="hidden" class="form-control" id="edit_local_id" name="edit_local_id">
    <div class="form-group col-sm-6">
     <label>ชื่อสถานที่ :</label>
     <input type="text" class="form-control" id="edit_local_name" name="edit_local_name" placeholder="ชื่อสถานที่ ...">
    </div>
    <div class="form-group col-sm-6">
     <label>IP address :</label>
     <input type="text" class="form-control" id="edit_local_ip" name="edit_local_ip" placeholder="IP Address ...">
    </div>
    </div>
    <div class="form-row">
     <div class="form-group col-sm-6">
    ...
    <div class="modal-footer">
     <button type="button" class="btn btn-success" data-dismiss="modal" onclick="submitUpdateLocal();"><i class="fa fa-save"></i> SAVE</button>
