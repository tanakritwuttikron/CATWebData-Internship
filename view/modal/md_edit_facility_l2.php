...
<div class="modal fade" id="editFacilityModal">
 <div class="modal-dialog">
   <div class="modal-content">
    ...
    <!-- Modal body -->
   <form action="../../database/update_facility_l2.php" method="post" name="md_form_facility" enctype="multipart/form-data">
    <div class="modal-body">
     <div class="form-group">
      ...
      <input type="hidden" class="form-control" id="edit_node_id" name="edt_node_id" value="">
      <label>ชื่อ :</label>
